...
openai.api_base = os.getenv("OPENAI_API_BASE")   #os.getenv('OPENAI_API_BASE')
openai.api_key =  os.getenv("OPENAI_API_KEY") #os.getenv('OPENAI_API_KEY')
openai.api_version = os.getenv("OOPENAI_API_VERSION")  #os.getenv('OPENAI_API_VERSION')

with Path(current_script_dir / "config.json").open() as config_file:
    config_details = json.load(config_file)

# Setting up the deployment name
deployment_name = os.getenv("GPT-4V_DEPLOYMENT_NAME")  #config_details["GPT-4V_DEPLOYMENT_NAME"]

# The base URL for your Azure OpenAI resource. e.g. "https://<your resource name>.openai.azure.com"
openai_api_base = os.getenv("OPENAI_API_BASE")  #config_details["OPENAI_API_BASE"]
...
openai_api_version = os.getenv("OPENAI_API_VERSION") # config_details["OPENAI_API_VERSION"]
